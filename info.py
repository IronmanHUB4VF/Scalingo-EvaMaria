...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001878326006').split()]
...
AUTH_CHANNEL = [int(ch) for ch in auth_channel.split()] if auth_channel else None
